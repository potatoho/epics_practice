...
#include "loopbackVersion.h"

/* must be last include */
#include "epicsExport.h"

const char version[] = loopbackVERSION;
...
static lsidset devloopbackVersion = {
	{5, NULL, NULL, NULL, NULL}, read_string
};
epicsExportAddress(dset,devloopbackVersion);
